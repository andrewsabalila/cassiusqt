...
**CASSIUSQT** is a **facebook messenger chatbot** that is made
...
- [x] `/info` : Displays info about CASSIUSQT.
...
### Cloning
- [x] Run `git clone https://github.com/andrewsabalila/cassiusqt` in your terminal
- [x] Then type `cd cassiusqt`
